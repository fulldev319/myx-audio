...
const MakeOfferModal = ({ open, onClose, songDetailData, refresh }) => {
  ...
  const handleConfirm = async () => {
    ...
    const collection = songDetailData?.nftAddress;
      ...
      {openTranactionModal ? (
        ...
        <Modal size="daoMedium" isOpen={open} onClose={onClose} showCloseIcon>
          <div className={classes.content}>
            <div className={classes.typo1}>Make an Offer</div>
            <Box
              mt={4}
              mb={1}
              display="flex"
            ...
            >
              <div className={classes.typo2}>Stablecoin</div>
              <InfoTooltip tooltip="" />
            </Box>
            <SongTokenSelect
              tokens={tokens}
              ...
              style={{ flex: '1' }}
            />
            <Box mt={1} mb={4} className={classes.typo2}>
            ...
            <Box
              ...
              justifyContent="space-between"
            >
              <div className={classes.typo2}>Amount</div>
              <InfoTooltip tooltip="" />
            </Box>
            ...
            <div className={classes.typo3}>{`${price}`} USD</div>
