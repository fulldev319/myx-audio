      ...
      <Box px={2}>
        ...
        <Box display="flex" flexDirection="column" mt={4}>
          ...
          <Box display="flex" flexDirection="row" alignItems="center" mt={1}>
            ...
            <Box width={1} ml={2}>
              <Select
                value={'2020-05-17'}
                className={`${commonClasses.outlineSelect} ${classes.select}`}
              >
                <MenuItem value={'2020-05-17'}>
                  <Box display="flex" flexDirection="row" alignItems="center">
                    <img
                      src={require('assets/musicDAOImages/USDp.webp')}
                      alt="usdp"
                      height={30}
                    />
        ...
        <Box display="flex" flexDirection="column">
          ...
          <Text size={FontSize.L}>
            Your liquidity will only earn fees from consumption of music within
            your
            <br />
            range.
