    ...
    <>
      ...
      <Box mt={3}>
        ...
        <FileUpload
          ...
          isBitrate
          extra
          extraText={`You can upload .mp3, .mp4 or .wav format. There is no file size limit, however if you upload long-form audio of any kind, dependng on your network you can expect longer encryption and upload times, so please be patient.`}
        />
      </Box>
      <Box mt={3}>
