...
const waxIcon = require('assets/tokenImages/WAX.webp');
  ...
  useEffect(() => {
    ...
    axios
      ...
      .catch((err) => {
        setIsDataLoading(false);
        console.error(
          'Swap-Modal connect getUserRegisteredEthAccount failed',
          err
        );
      });
  }, []);
      ...
      <LoadingWrapper loading={isDataLoading}>
        {waxWallet && (
          <WalletButton
            ...
            handleClick={() =>
              props.handleWaxConnect && props.handleWaxConnect(waxWallet)
            }
            disabled={disabled}
          />
        )}
