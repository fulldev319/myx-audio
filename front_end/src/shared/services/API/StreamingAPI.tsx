...
export const getStreaming = async ({
  ...
  const { data } = await axios.post<StreamingDTO>(
    `${URL()}/streaming/getStreaming`,
    { streamingId, type }
  );
...
export const joinStreaming = async ({
  streamingId,
  type
}: {
  streamingId: string;
  ...
  const response = await axios.post<JoinStreamingResult>(
    `${URL()}/streaming/joinStreaming`,
    {
      streamingId,
      type
    }
...
export const exitMediaLiveStreaming = async ({
  userId,
  docId,
  podAddress,
  type
}: ExitStreamingParams): Promise<void> => {
  const response = await axios.post<MediaLiveStreamingResultDTO>(
...
export const enterMediaStreaming = async ({
  ...
  const response = await axios.post<MediaLiveStreamingResultDTO>(
    `${URL()}/streaming/enterMediaStreaming`,
    {
      Listener: userId,
      MediaSymbol: docId,
      PodAddress: podAddress,
...
export const exitMediaStreaming = async ({
  userId,
  docId,
  podAddress,
  type
  ...
  const response = await axios.post<MediaLiveStreamingResultDTO>(
    `${URL()}/streaming/exitMediaStreaming`,
    {
      Listener: userId,
      MediaSymbol: docId,
      PodAddress: podAddress,
...
export const getEarnings = async ({
  ...
  const response = await axios.post<StreamingEarnings>(
    `${URL()}/streaming/getEarnings`,
    {
      streamingId,
      type
    }
...
export const addStreamingToWatchlist = async ({
  streamingId,
  type
}: {
  streamingId: string;
...
export const isStreamingWatchlisted = async ({
  streamingId,
  type
}: {
  streamingId: string;
