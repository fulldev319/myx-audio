...
const exchange = (network) => {
  const contractAddress =
    config[network].CONTRACT_ADDRESSES.ERC721_TOKEN_EXCHANGE;
  ...
  const PlaceERC721TokenBuyingOffer = async (
    web3: Web3,
    account: string,
    payload: any
  ): Promise<any> => {
    return new Promise(async (resolve) => {
      try {
        ...
        const result = {
          data: {
            offerId:
              response.events.ERC721TokenBuyingOfferPlaced.returnValues[0]
          },
          transaction: {
            From: response.from,
            To: response.to,
  ...
  const PlaceERC721TokenSellingOffer = async (
    web3: Web3,
    account: string,
    payload: any
  ): Promise<any> => {
    return new Promise(async (resolve) => {
      try {
        ...
        const result = {
          data: {
            offerId:
              response.events.ERC721TokenSellingOfferPlaced.returnValues[0]
          },
          transaction: {
            From: response.from,
            To: response.to,
  ...
  const BuyERC721TokenFromOffer = async (
    web3: Web3,
    account: string,
    payload: any
  ): Promise<any> => {
  ...
  const SellERC721TokenFromOffer = async (
    web3: Web3,
    account: string,
    payload: any
  ): Promise<any> => {
  ...
  const CancelERC721TokenBuyingOffer = async (
    web3: Web3,
    account: string,
    payload: any
  ): Promise<any> => {
  ...
  const CancelERC721TokenSellingOffer = async (
    web3: Web3,
    account: string,
    payload: any
  ): Promise<any> => {
  ...
  const getErc721OfferById = async (
    web3: Web3,
    account: string,
    offerId: any
  ): Promise<any> => {
  ...
  const getErc721OfferCount = async (
    web3: Web3,
    account: string
  ): Promise<any> => {
    return new Promise(async (resolve) => {
  ...
  const getErc721ExchangeById = async (
    web3: Web3,
    account: string,
    exchangeId: any
  ): Promise<any> => {
    return new Promise(async (resolve) => {
      try {
        const contract = ContractInstance(web3, metadata.abi, contractAddress);
        contract.methods
          .getErc721ExchangeById(exchangeId)
          .call((err, result) => {
            if (err) {
              console.log(err);
              resolve(null);
  ...
  const getErc721ExchangeAll = async (
    web3: Web3,
    account: string
  ): Promise<any> => {
    return new Promise(async (resolve) => {
