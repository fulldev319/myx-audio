...
const MessageWidget: React.FC<MessageWidgetProps> = ({
  ...
  const onChangeMessageOther = (file: any) => {
    ...
    if (typeChat === 'ClaimableSongs') {
      url = `${URL()}/claimableSongs/addMessageFile/${chat.chat.id}/${
        userSelector.id
      }`;
    } else {
      url = `${URL()}/mediaOnCommunity/addMessageFile/${chat.chat.id}/${
        userSelector.id
      }/${typeChat}`;
    }
  ...
  const onChangeMessagePhoto = (file: any) => {
    ...
    let url: string = '';
    if (typeChat === 'ClaimableSongs') {
      url = `${URL()}/claimableSongs/addMessagePhoto/${chat.chat.id}/${
        userSelector.id
      }`;
    } else {
      url = `${URL()}/mediaOnCommunity/addMessagePhoto/${chat.chat.id}/${
        userSelector.id
      }/${typeChat}`;
    }
  ...
  const onChangeMessageAudio = (file: any) => {
    ...
    let url: string = '';
    if (typeChat === 'ClaimableSongs') {
      url = `${URL()}/claimableSongs/addMessageAudio/${chat.chat.id}/${
        userSelector.id
      }`;
    } else {
      url = `${URL()}/mediaOnCommunity/addMessageAudio/${chat.chat.id}/${
        userSelector.id
      }/${typeChat}`;
    }
  ...
  const onChangeMessageVideo = (file: any) => {
    ...
    let url: string = '';
    if (typeChat === 'ClaimableSongs') {
      url = `${URL()}/claimableSongs/addMessageVideo/${chat.chat.id}/${
        userSelector.id
      }`;
    } else {
      url = `${URL()}/mediaOnCommunity/addMessageVideo/${chat.chat.id}/${
        userSelector.id
      }/${typeChat}`;
    }
  ...
  return (
    <div className={isDarkTheme ? classes.rootDark : classes.root}>
      ...
      <div
        className={isDarkTheme ? classes.inputPanelDark : classes.inputPanel}
      >
        ...
        {!audioMessage && isDarkTheme && (
          ...
          >
            ...
            <button>
              {isDarkTheme ? (
                <img
                  src={require('assets/icons/send_white_2.webp')}
                  alt="send"
                />
              ) : (
                <SendIcon />
