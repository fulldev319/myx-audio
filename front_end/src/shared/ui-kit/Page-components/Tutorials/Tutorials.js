export const communitiesTutorials = {
  ...
  Tutorials: [
    {
      Title: 'How to Get Started with MUSIC Communities',
      Body:
        'Communities are the heartbeat of the MUSIC network. Here, groups, businesses, creators, and individuals can self-govern, mint and distribute a community token, connect, vote and discuss. In the very near future, these communities will be able to customize their very own platforms. To learn more, click next.',
      Image: 'communities01'
    },
    {
    ...
    },
    {
      ...
      Body:
        'Inside each community, there are a number of things you can do. Join discussion groups! Follow the community blog! Track the social token and metrics! Music aims to have each community select No Code  intricately built features to customize their own community, (this means that you can drag&drop features without any tech skills!).',
      Image: 'communities03'
    },
    {
    ...
    },
    {
      ...
      Body:
        'When creating a community, you will be able to create a “Community Token,” and along with it, define its financial characteristics. This token rises and falls based on the number of transactions as well as basic principles of supply and demand. Music has built a bridge with popular blockchains, for example Ethereum, for these tokens to move in and out of the Music blockchain. Within Music, these tokens are free to mint and distribute.',
      Image: 'communities05'
    },
    {
    ...
    },
    {
      ...
      Body:
        'As Music grows, so will the abundance of custom built features at your disposal. These features will require no tech skills, can be ‘drag and dropped’ into your community. See a feature you might like? Propose a project to a group of freelance developers. The possibilities of Music are only limited to our imaginations!',
      Image: 'communities07'
    }
  ]
};
...
export const podsTutorials = {
  ...
  Tutorials: [
    {
      Title: 'How to Get Started with MUSIC Pods',
      Body:
        'Pods provide immense utility to the MUSIC network. As highly functional social and financial spaces, Pods generate crypto tokens so you can create and trade alternate assets, like digital content or property, in the form of digital and physical NFTs. You can also create a Pod to raise money as they also generate Fungible tokens. All Pods can be insured, invested across with Indexes, and easily distributed on MUSIC web and mobile applications. With Pods, any imaginable asset can be tokenized.',
      Image: 'pods01'
    },
    {
      Title: 'Types of Pods',
    ...
    },
    {
      ...
      Body:
        'Physical non-fungible tokens represent physical assets, for example property, high end cars or collectibles. The key to this type of Pod is it’s seamless connection to decentralized Insurance pools by MUSIC. Here, investors can earn interest and insure Physical NFT Pods. ',
      Image: 'pods05'
    },
    {
      Title: 'Insure Your Pods',
      Body:
        'Pods deal with assets, often assets that are not in the investors hands. It is then germane to have Pods be insured. Pod creators can apply to have their assets insured, or Insurance pools can contact Pod creators themselves. If a Pod is insured, for example if a property Title and the property itself is insured, the Physical NFT Pod is much more likely to generate investor interest. Insurance pools are started by known entities (Image is just an example) and unknown entities and users can invest in the Insurance pools, in exchange for MUSIC Insurance Coins which earn interest from the Pod. ',
      Image: 'pods06'
    },
    {
      Title: 'Swap Your Pod Tokens',
      Body:
        'Pod tokens, while providing immenses investment opportunities, is also built to be a highly liquid market. Pod tokens can be swapped for BTC, ETH or any other popular token with MUSIC Swap. Holding Pod tokens also provide interest (fungible tokens) or royalties (non-fungible tokens). ',
      Image: 'pods07'
    },
    {
...
export const creditPoolsTutorials = {
  ...
  Tutorials: [
    {
      Title: 'How to Get Started with MUSIC Pools',
      Body:
        'MUSIC Credit Pools are a decentralized financial protocol dictating that borrowers do not necessarily need to lock or deposit crypto in order to receive credit. While lenders earn high interest and limit their risk with an innovative risk pool mechanism by MUSIC. ',
      Image: 'creditPools01'
    },
    {
