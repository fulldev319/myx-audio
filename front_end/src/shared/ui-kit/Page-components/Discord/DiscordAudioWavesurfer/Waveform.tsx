...
const Waveform = React.memo((props: any) => {
  ...
  return (
    <div
      ...
      style={{ width: showTime ? '100%' : 'auto' }}
    >
      <div
        className={`audioPlayer ${showTime ? 'showTime' : ''} ${
          fullWidth && 'fullWidth'
        }`}
        style={
          isFromProfilePane
      ...
      >
          ...
          {playing ? (
            <div
              ...
              style={{
                ...
                border: showTime
                  ? '5px solid white'
                  : '2px solid rgb(69, 207, 234)',
                borderRadius: showTime ? '50%' : 0,
                color: isFromProfilePane
                  ? 'white'
                  : showTime
                  ? 'black'
        ...
        <ReactWaves
          ...
          zoom={1}
          playing={playing}
          className={isFromProfilePane ? 'wave-container' : ''}
