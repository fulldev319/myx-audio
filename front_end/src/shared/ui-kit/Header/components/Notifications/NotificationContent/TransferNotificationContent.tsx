...
export const TransferNotificationContent: React.FunctionComponent<
  TransferNotificationContentProps
> = ({
  notification: {
    type,
    itemId,
  ...
  return isIncoming ? (
    ...
    <div>
      You have made {transferTextWithMediaSymbol} of {amount} {token} to{' '}
      {userLink}
    </div>
  );
};
