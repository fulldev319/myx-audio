...
const qrCodeIcon = require('assets/icons/qrcode.webp');

export const ShareWithQRCode = ({
  mediaId = null,
  shareLink,
  onClose,
  isOpen
    ...
    >
      <div className={classes.modalContent}>
        <div className={classes.mainContent}>
          ...
          <h6>
            Download your QR code and use it a simple way to give others access
            to this media.
          </h6>
        </div>
        <div>
