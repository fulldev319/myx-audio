...
export async function CreateERC721TokenExchange(
  web3: Web3,
  account: string,
  payload: any
): Promise<any> {
  return new Promise(async (resolve) => {
    try {
      ...
      const result = {
        data: {
          exchangeId:
            response.events.ERC721TokenExchangeCreated.returnValues[0],
          initialOfferId:
            response.events.ERC721TokenExchangeCreated.returnValues[1]
        },
        transaction: {
          From: response.from,
          To: response.to,
...
export async function PlaceERC721TokenBuyingOffer(
  web3: Web3,
  account: string,
  payload: any
): Promise<any> {
...
export async function PlaceERC721TokenSellingOffer(
  web3: Web3,
  account: string,
  payload: any
): Promise<any> {
...
export async function BuyERC721TokenFromOffer(
  web3: Web3,
  account: string,
  payload: any
): Promise<any> {
...
export async function SellERC721TokenFromOffer(
  web3: Web3,
  account: string,
  payload: any
): Promise<any> {
...
export async function CancelERC721TokenBuyingOffer(
  web3: Web3,
  account: string,
  payload: any
): Promise<any> {
  return new Promise(async (resolve) => {
    try {
      ...
      const result = {
        data: {
          offerId:
            response.events.ERC721TokenBuyingOfferCanceled.returnValues[0]
        },
        transaction: {
          From: response.from,
          To: response.to,
...
export async function CancelERC721TokenSellingOffer(
  web3: Web3,
  account: string,
  payload: any
): Promise<any> {
  return new Promise(async (resolve) => {
    try {
      ...
      const result = {
        data: {
          offerId:
            response.events.ERC721TokenSellingOfferCanceled.returnValues[0]
        },
        transaction: {
          From: response.from,
          To: response.to,
...
export async function getErc721OfferById(
  web3: Web3,
  account: string,
  offerId: any
): Promise<any> {
...
export async function getErc721OfferAll(
  web3: Web3,
  account: string
): Promise<any> {
  return new Promise(async (resolve) => {
...
export async function getErc721OfferCount(
  web3: Web3,
  account: string
): Promise<any> {
  return new Promise(async (resolve) => {
...
export async function getErc721ExchangeById(
  web3: Web3,
  account: string,
  exchangeId: any
): Promise<any> {
...
export async function getErc721ExchangeAll(
  web3: Web3,
  account: string
): Promise<any> {
  return new Promise(async (resolve) => {
...
export async function CreateERC20TokenExchange(
  web3: Web3,
  account: string,
  payload: any
): Promise<any> {
  return new Promise(async (resolve) => {
    try {
      ...
      const gas = await contract.methods
        .CreateERC20TokenExchange(payload)
        .estimateGas({ from: account });
...
export async function CreateERC1155TokenExchange(
  web3: Web3,
  account: string,
  payload: any
): Promise<any> {
  return new Promise(async (resolve) => {
    try {
      ...
      const gas = await contract.methods
        .CreateERC1155TokenExchange(payload)
        .estimateGas({ from: account });
      await contract.methods
        .CreateERC1155TokenExchange(payload)
        .send({ from: account, gas: gas });
