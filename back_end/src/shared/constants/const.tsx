...
export enum Gradient {
  ...
  Blue = 'linear-gradient(88.38deg, #4434FF 7.67%, #2B99FF 102.5%), linear-gradient(97.63deg, #A0D800 26.36%, #0DCC9E 80%)'
}
...
export enum ContentType {
  SongSingleEdition = 'single-edition-song',
  SongMultiEdition = 'multiple-edition-song',
  PodInvestment = 'investment-pod',
  PodCollaborative = 'collaborative-pod'
}
