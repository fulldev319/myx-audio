...
export const ConnectMusicWalletView = ({
  handleCancel = () => {},
  handleConnect = () => {}
}) => {
  return (
    <div className="wallet-view">
      ...
      <div className="body">
        <div className="connection">
          <img src={require('assets/walletImages/music_wallet.svg')} />
          <img src={require('assets/walletImages/music_wallet.svg')} />
        </div>
        <div className="title">Music would like to connect to your account</div>
...
export const WalletSignInAlert = ({ handleSignIn = () => {} }) => {
  return (
    <div className="sign-in-view">
      ...
      <div className="title">
        Final step! Your wallet will ask you to digitally sign in your wallet
      </div>
      <div className="action">
    ...
    <div className="signature-request-view">
      ...
      <div className="body">
        ...
        <div className="long-desc">
          <p>
            Ultricies adipiscing pharetra dignissim consectetur elit faucibus
            urna odio congue. Feugiat lorem eros, erat integer. Cras est
            viverra. Tellus facilisis consequat integer justo, imperdiet ut est.
            Magna sed at amet ac tempor. Ac pulvina.
          </p>
          <p>
            commodo nisl dignissim nisl ornare nunc. Eu quisque mi, felis
            bibendum mattis ac. Urna enim sit sapien, feugiat dapibus cras eget.
            Nec tempus blandit amet sit. Adipiscing libero.
          </p>
        </div>
        <div className="action">
...
export default function ConnectModal(props) {
  ...
  return (
    ...
    >
      <div
        className="modal-content w50 connect-modal"
        style={{ width: 576, minHeight: 350 }}
      >
        <div className="exit" onClick={props.handleClose}>
          <img src={require('assets/icons/x_darkblue.webp')} alt={'x'} />
        </div>

        {status !== VIEW_WALLET_NORMAL ? (
          (status === VIEW_WALLET_CONNECT_MUSIC && (
            <ConnectMusicWalletView
              handleConnect={() => {
                setMenuSelection(1);
                setViewStatus(VIEW_WALLET_NORMAL);
              }}
          ...
          <>
            ...
            <div className="content">
              {menuSelection === 0 ? (
                <ConnectWalletTab
                  handleMusicWallet={() =>
                    setViewStatus(VIEW_WALLET_CONNECT_MUSIC)
                  }
                  ...
                  handleWalletConnect={() =>
                    setViewStatus(VIEW_WALLET_CONNECT_SERVICE)
                  }
                />
              ) : menuSelection === 1 ? (
                <MyWalletsTab
