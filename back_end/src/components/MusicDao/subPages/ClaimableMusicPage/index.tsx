...
import PodCard from 'components/MusicDao/modals/Claimable/PodCard';
...
export default function ClaimableMusicPage() {
  ...
  const [openHowItWorksModal, setOpenHowItWorksModal] =
  ...
  return (
    <Box className={classes.container}>
      <img src={require('assets/musicDAOImages/background.webp')} />
      <div className={classes.body} ref={scrollRef}>
        <img
          className="left-logo"
          src={require('assets/musicDAOImages/leftMusicDaoLogo.webp')}
        />
        <img
          className="right-logo"
          src={require('assets/musicDAOImages/rightMusicDaoLogo.webp')}
        />
        <Box
          display="flex"
          flexDirection="column"
        ...
        >
          ...
          <span className={classes.headerTitle}>
            <span> Create NFTs, invite collaborators, get investment </span>
          </span>
          <Box className={classes.buttons} display="flex" mt={4} mb={4}>
            <SecondaryButton size="medium">Stake Music</SecondaryButton>
            <PrimaryButton
              size="medium"
        ...
        <Box className={classes.filterContainer}>
          <div className={classes.searchInputBox}>
            <input
              ...
              autoFocus
              placeholder={'Search artist, track, collection or more'}
              value={searchValue}
