    ...
    axios
      ...
      .then((response) => {
        if (response.data.success) {
          setMessagesReply(response.data.data);
        }
        ...
        <div className="messageRowDiscordChatReply">
          <div
            onClick={() => {
              history.push(
                `/profile/${
                  propsFunction.message.user?.urlSlug ??
                  propsFunction.message.from
                }`
              );
            ...
            style={{
              backgroundImage: `url("${
                ...
                propsFunction.message.user.imageURL.length > 0
                  ? processImage(propsFunction.message.user.imageURL)
                  : getDefaultAvatar()
              }")`,
            ...
            <div className="actionsRowReply">
              ...
              propsFunction.message.likes.findIndex(
                ...
                <div
                  ...
                  onClick={() => likeReplyMessage(propsFunction.message)}
                >
                  <SvgIcon>
                    <ThumbsUpSolid />
                  </SvgIcon>
              ...
              propsFunction.message.dislikes.findIndex(
                (user) => user === userSelector.id
              ) !== -1 ? (
                <div className="podIconCenterFlex">
                ...
                <div
                  className="podIconCenterFlex"
                  onClick={() => dislikeReplyMessage(propsFunction.message)}
                >
                  <SvgIcon>
                    <ThumbsDownSolid />
                  </SvgIcon>
              ...
              <div
                className="podIconCenterFlex"
                onClick={handleOpenGiveTipModal}
              >
                Give tip
              </div>
              <GiveTipModal
        ...
        <div className="messageDiscordChatReplyModal">
          <div className="messageRowDiscordChatReplyModal">
            <div
              onClick={() => {
                history.push(
                  `/profile/${message.user?.urlSlug ?? message.from}`
                );
              ...
              style={{
                backgroundImage: `url("${
                  message.user.imageURL && message.user.imageURL.length > 0
                    ? processImage(message.user.imageURL)
                    : getDefaultAvatar()
                }")`,
                backgroundRepeat: 'no-repeat',
                backgroundSize: 'cover',
            ...
            <div className="messageInfoDiscordChatReplyModal">
                ...
                <div
                  ...
                  style={{
                    backgroundImage:
                      ...
                      message &&
                      message.id
                        ? `url(${URL()}/chat/discord/getMessagePhoto/${
                            props.discordId
                          }/${message.discordRoom}/${message.id})`
                        : 'none',
                    backgroundPosition: 'center',
                    backgroundRepeat: 'no-repeat',
                    backgroundSize: 'cover'
              ...
              <div className="actionsRowReplyModal">
                {message.likes &&
                message.likes.findIndex((user) => user === userSelector.id) !==
                  -1 ? (
                  <div className="podIconCenterFlex">
                    <SvgIcon htmlColor={'green'}>
                      <ThumbsUpSolid />
                ...
                message.dislikes.findIndex(
                  ...
                  <div
                    className="podIconCenterFlex"
                    onClick={() => dislikeMessage(message)}
                  >
                    <SvgIcon>
                      <ThumbsDownSolid />
                    </SvgIcon>
          ...
          <div className="inputDiscordChatReplyModal">
            ...
            >
              ...
              <button style={{ backgroundColor: '#64c89e' }}>
                <div style={{ color: 'white', height: 25, width: 25 }}>
                  <SendIcon />
                </div>
              </button>
            </form>
