...
export default function FreeMusicPage() {
  ...
  const getTransactonTableData = () => {
    ...
    TRANSACTIONS.map((item) => {
      ...
      row.push({
        cell: (
          <Box className={classes.header5}>{item.stakingAmmount} MUSIC</Box>
        ),
        cellAlign: 'center'
      });
      row.push({
      ...
      row.push({
        cell: <ShareMusicIcon color="#65CB63" />,
        cellAlign: 'center'
      });
  ...
  //     });
  //     row.push({
  //       cell: <ShareMusicIcon color="#FF8E3C" />,
  //       cellAlign: "center",
  //     });
      ...
      <Box className={classes.graphBox} zIndex={1} mt={6}>
        ...
        <div className={classes.graphFilterBox}>
          <Box className={classes.flexBox}>
            <div className={classes.header2_4}>
