...
import StakingModal from 'components/MusicDao/modals/StakingModal';
      ...
      <Box className={classes.container}>
        ...
        <Box display="flex" flexDirection="column">
          <Box className={classes.itemBox} mb={5}>
            ...
            <Box
              className={`${classes.bgLinear1} ${classes.round} ${
                props.isStack && 'stack'
              }`}
            >
              <img
                ...
                alt="music"
                style={{
                  top: props.isStack ? -50 : -90,
                  left: props.isStack ? 0 : -40
                }}
              />
              <span>1</span>
            </Box>
            <Box className={classes.textContainer}>
              <div className={classes.text}>
                {props.isStack
                  ? 'Use our Music stake calculator and calculate your potential rewards.'
                  : 'Stake Music Tokens and get claimable tracks to upload on the Music DAO.'}
              </div>
            </Box>
          </Box>
          <Box className={classes.itemBox} mb={5}>
            ...
            <div className={classes.hr} />
            <Box
              className={`${classes.bgLinear2} ${classes.round} ${
                props.isStack && 'stack'
              }`}
              mr={6}
            >
              <img
                src={require(`assets/musicDAOImages/${
                  props.isStack ? 'clock_stack' : 'yield-green'
                }.webp`)}
                alt="music"
                style={{
                  top: props.isStack ? -50 : -50,
                  left: props.isStack ? 0 : -20
                }}
              />
              <span>2</span>
            </Box>
            <Box className={classes.textContainer}>
              <div className={classes.text}>
                {props.isStack
                  ...
                  : 'These claimable tracks generate revenue when listened by other people.'}
              </div>
            </Box>
          </Box>
          {/* <Box className={classes.itemBox} mb={5}>
            ...
            <Box className={classes.textContainer}>
              <div className={classes.text}>
                {props.isStack
                  ...
                  : "When artist(s) claim, 1% of the revenue generated is distributed between uploaders of the track."}
              </div>
            </Box>
          </Box> */}
          <Box className={classes.itemBox}>
            <div className={classes.dot} />
            <Box
              className={`${classes.bgLinear4} ${classes.round} ${
                props.isStack && 'stack'
              }`}
              mr={6}
            >
              <img
                src={require(`assets/musicDAOImages/${
                  props.isStack ? 'return' : 'reward'
                }.webp`)}
                alt="music"
                style={{
                  top: props.isStack ? -50 : -45,
                  left: props.isStack ? 0 : -10
                }}
              />
              <span>3</span>
            </Box>
            <Box className={classes.textContainer}>
              <div className={classes.text}>
                {props.isStack
                  ? 'You can get your staked Music back whenever you want by paying the remaining pUSD to repay the loan.'
