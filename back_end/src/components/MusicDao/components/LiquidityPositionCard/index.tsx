  ...
  return (
    <Box
      className={classnames(
        commonClasses.card,
        classes.positionCard,
        data.type === 'Remove' && classes.removeCard
      )}
      pt={5}
      pb={3}
      px={3}
    >
      <Text size={FontSize.H4_5} bold>
        Liquidity Position
      </Text>
      <Box
        display="flex"
      ...
      >
        {data.type === 'Add' &&
          (data.status === 0 ? (
            <>
              ...
              <PrimaryButton size="medium" className={classes.primaryButton}>
                Borrow
              </PrimaryButton>
            </>
          ) : (
            <>
              <SecondaryButton
                size="medium"
                className={classes.secondaryButton}
                onClick={() => history.push('/liquidity/position/123456')}
              >
                Manage
              </SecondaryButton>
              <SecondaryButton
              ...
              >
                ...
                >
                  <path
                    d="M4.51985 2.43119C4.51985 3.57758 3.59052 4.50691 2.44413 4.50691C1.29774 4.50691 0.368408 3.57758 0.368408 2.43119C0.368408 1.2848 1.29774 0.355469 2.44413 0.355469C3.59052 0.355469 4.51985 1.2848 4.51985 2.43119Z"
                    fill="#2D3047"
                  />
                  <path
                    d="M13.5198 2.43119C13.5198 3.57758 12.5905 4.50691 11.4441 4.50691C10.2977 4.50691 9.36841 3.57758 9.36841 2.43119C9.36841 1.2848 10.2977 0.355469 11.4441 0.355469C12.5905 0.355469 13.5198 1.2848 13.5198 2.43119Z"
                    fill="#2D3047"
                  />
                  <path
                    d="M22.5198 2.43119C22.5198 3.57758 21.5905 4.50691 20.4441 4.50691C19.2977 4.50691 18.3684 3.57758 18.3684 2.43119C18.3684 1.2848 19.2977 0.355469 20.4441 0.355469C21.5905 0.355469 22.5198 1.2848 22.5198 2.43119Z"
                    fill="#2D3047"
                  />
                </svg>
              </SecondaryButton>
        ...
        {data.type === 'Remove' && (
          <SecondaryButton size="medium" className={classes.secondaryButton}>
            Unstake
          </SecondaryButton>
        )}
      </Box>
