...
import { MintEditionStepType } from '../CreateSongModalNew';
import { useSignAllBatchModalStyles } from './index.styles';
...
export default function SignAllBatchModal({
  onClose,
  open,
  isStreaming,
  onMintMaster,
  ...
  const classes = useSignAllBatchModalStyles();

  const [openCloseModal, setOpenCloseModal] = useState<boolean>(true);
  ...
  const handleCloseSubModal = (result) => {
  ...
  return (
    ...
    >
      <div className={classes.content}>
        ...
        >
          <h5 style={{ margin: 0 }}>Please sign and mint your NFTs</h5>
          <h3 style={{ margin: 0 }}>
            Sign all batches of your NFT editions, you can save your minting and
            come back to it later. Make sure you have enough MATIC to cover the
            fees (avg for a batch of 20 NFTs as of Jan 30 is $0.25 MATIC)
          </h3>
        </Box>
        ...
        <div className={classes.buttons} style={{ justifyContent: 'end' }}>
          <PrimaryButton
            size="medium"
            isRounded
            style={{
      ...
      <Modal
        ...
        onClose={() => handleCloseSubModal(false)}
        showCloseIcon
      >
        <div className={classes.content}>
          <Box
            ...
            justifyContent="center"
          >
            <h5 style={{ margin: 0 }}>Close Minting</h5>
            <h3 style={{ margin: 0 }}>
              You can finish this process later by opening it from your Profile
              - Songs tab to mint rest of your editions later.
            </h3>
          </Box>
          <div className={classes.buttons}>
            <PrimaryButton
              ...
              onClick={() => handleCloseSubModal(false)}
            >
              Cancel
            </PrimaryButton>
            <PrimaryButton
              ...
              onClick={() => handleCloseSubModal(true)}
            >
              Yes, finish later
            </PrimaryButton>
          </div>
