    ...
    >
      <div className="avatar-container">
        <div
          ...
          style={{
            backgroundImage: `url("${
              otherUser.userFoto ?? getDefaultAvatar()
            }")`,
      ...
      <div className="item-content">
        ...
        {typeof chat.lastMessage === 'string' && (
          <div className="message" style={{ color: 'rgba(84, 101, 143, 0.6)', fontFamily: 'Pangram Regular' }}>
        ...
        {chat.lastMessage && (
          <div className="date" style={{ color: 'rgba(84, 101, 143, 0.6)', fontFamily: 'Pangram Regular' }}>
