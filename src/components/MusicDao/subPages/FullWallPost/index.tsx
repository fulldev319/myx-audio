          ...
          <Box className={classes.card} pl={11} pr={8} py={8} mt={5} mb={5}>
            ...
            >
              <Box display="flex" flexDirection="row" alignItems="center">
                <Avatar
                  size={40}
                  image={processImage(discussion.imageURL)}
                  rounded
                />
            ...
            <Box display="flex" flexDirection="column">
              ...
              />
              <Text mt={5}>
                Some analysts, however, expect bitcoin to remain resilient if
                inflation continues to rise, which could lead to outperformance
                versus traditional markets. In a newsletter published on
                Wednesday, EQUOS, a digital asset financial services company,
                described the initial down move across risk assets as a
                “knee-jerk reaction.” “Bitcoin and stocks will likely correlate
                through the turbulence, before reality hits: Inflation is likely
                to see bitcoin outperform stocks,” EQUOS wrote.
              </Text>
              <Text mt={6}>
                Some analysts, however, expect bitcoin to remain resilient if
                inflation continues to rise, which could lead to outperformance
              ...
              <Text mt={4}>
                Since May, the cost to fund long positions in the market for
                bitcoin perpetual swaps, a type of derivative in the
                cryptocurrency markets similar to futures contracts in
                traditional markets, has been in negative territory. Such a
                scenario sometimes precedes spot price recoveries.
              </Text>
              <Text mt={3}>
                Iron Titanium token (TITAN), the share token of a decentralized
                finance (DeFi) protocol, has fallen to near zero from $60 in one
                day, bringing the worth of the protocol down from $2 billion at
                one point to near zero.
              </Text>
            </Box>
            ...
            >
              <Box className={classes.pointer} onClick={handleLike}>
                <LikeIcon
                  color={like ? Color.MusicDAOGreen : Color.MusicDAODark}
                />
              </Box>
