...
export default function FeedsSubPage({ platform }) {
  ...
  return (
    <Box className={classes.root}>
      <Box className={classes.feedContainer}>
        ...
        >
          <Box width={'30%'}>NFT</Box>
          <Box width={'10%'}>Account</Box>
          ...
          <Box width={'4%'} textAlign="center"></Box>
        </Box>
        <Box>
          <InfiniteScroll
              ...
              >
                <Box width={'30%'} display="flex" alignItems="center">
                  <Avatar
                    size={46}
                    rounded
                    image={processImage(item?.image) ?? getDefaultAvatar()}
                  />
                  <Box display="flex" flexDirection="column" ml={1.5}>
                    <Box className={classes.typo2} mb={0.5}>
                      {item.name}
                    </Box>
                    <Box className={classes.typo3}>{platform.name}</Box>
                  </Box>
                </Box>
                <Box width={'10%'} className={classes.typo4}>
                  {shortId(item.to)}
                </Box>
                <Box width={'20%'} textAlign="center">
                ...
                <Box
                  ...
                  onClick={() =>
                    handleGotoNFT(item.collection, item.tokenId, item.source)
                  }
                >
                  <LeftIcon />
                </Box>
