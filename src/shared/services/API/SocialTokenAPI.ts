...
export async function createSocialToken(payload: any): Promise<any> {
  try {
    const response = await axios.post(
      `${URL()}/social/createSocialToken/v2`,
      payload
    );
...
export async function allocateSocialToken(payload: any): Promise<any> {
  try {
    const response = await axios.post(
      `${URL()}/social/allocateSocialToken/v2`,
      payload
    );
    return response.data;
  } catch (e) {
...
export async function airdropSocialToken(payload: any): Promise<any> {
  try {
    const response = await axios.post(
      `${URL()}/social/airdropSocialToken/v2`,
      payload
    );
    return response.data;
  } catch (e) {
...
export async function sellSocialToken(
  payload: IBuySellSocialToken,
...
export async function buySocialToken(
  payload: IBuySellSocialToken,
  additionalData: Object
): Promise<any> {
  try {
...
export async function withdrawSocialToken(
  ...
  try {
    ...
    const response = await axios.post(
      `${URL()}/social/withdrawSocialToken/v2`,
      body
    );
    return response.data;
  } catch (e) {
...
export async function withdrawFundingToken(
  ...
  try {
    ...
    const response = await axios.post(
      `${URL()}/social/withdrawFundingToken/v2`,
      body
    );
    return response.data;
  } catch (e) {
...
export async function getOwnSocialToken(userId: string): Promise<any> {
  try {
    const response = await axios.get(
      `${URL()}/social/getOwnSocialToken/${userId}`
    );
    return response?.data;
  } catch (e) {
    console.log(e);
...
export async function getSocialTokenTransactionHistory(
  poolAddress: string
): Promise<any> {
  try {
    const response = await axios.get(
      `${URL()}/social/getTransactionHistory/${poolAddress}`
    );
    return response?.data;
  } catch (e) {
    console.log(e);
...
export async function getSocialTokenPriceHistory(
  poolAddress: string
): Promise<any> {
  try {
    const response = await axios.get(
      `${URL()}/social/getPriceHistory/${poolAddress}`
    );
    return response?.data;
  } catch (e) {
    console.log(e);
