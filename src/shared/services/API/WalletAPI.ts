...
export const connectMusicWallet = async (payload) => {
  return axios
    .post(`${URL()}/wallet/connectMusicWallet`, payload)
    .then(successFunc)
    .catch(failFunc)
    .finally(() => {
      // show alert message
...
export async function getTypeToTokenListMap(): Promise<{
  [key: string]: string[];
}> {
...
export async function getTotalBalanceHistoryByType(address): Promise<any> {
  const res = await axios.get(`${URL()}/wallet/getTotalBalanceHistoryByType`, {
    params: { address }
  });
  return res.data;
}
...
export async function registerUserEthAccount(request): Promise<any> {
  return axios
    .post(`${URL()}/wallet/registerUserEthAccount`, request)
    .then(successFunc)
    .catch(failFunc);
}
...
export async function getTokenHolders(token): Promise<any> {
  try {
    const response = await axios.get(
      `${URL()}/wallet/getTokenHolders/v2/${token}`
    );
    return response.data;
  } catch (e) {
    console.log(e);
...
export async function getBalancesOfAddressHLF(
  address,
  bookmark,
  pageSize
): Promise<any> {
  try {
    ...
    const response = await axios.get(
      URL() + '/wallet/getBalancesOfAddress',
      config
    );
...
export async function getTokenOfAddressByTypeHLF(
  address,
  tokenType,
  bookmark,
  pageSize
  ...
  try {
    ...
    const response = await axios.get(
      URL() + '/wallet/getTokenOfAddressByType',
      config
    );
    if (response.data?.success) return response.data?.data;
    else {
...
export async function getTokenOfAddressByTypesHLF(
  address,
  tokenTypes,
  bookmark,
  pageSize
  ...
  try {
    ...
    tokenTypes.forEach((tokenType) => {
      ...
      promises.push(
        axios.get(URL() + '/wallet/getTokenOfAddressByType', config)
      );
    });
...
export async function getAddressStreamingsHLF(address, token): Promise<any> {
  try {
    ...
    const response = await axios.get(
      URL() + '/wallet/getAddressStreamings',
      config
    );
...
// getter for a list of tokens
export async function getAddressStreamingsOfTokensHLF(
  address,
  tokens
): Promise<any> {
  try {
