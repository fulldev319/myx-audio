...
const infoIconWhite = require('assets/icons/info_white.webp');
const imageIcon = require('assets/icons/image_icon.webp');
const imageIconDark = require('assets/icons/image_icon_dark.webp');
const imageIconWhite = require('assets/icons/image_icon_white.webp');
const imageIconGreen = require('assets/icons/image_icon_green.webp');
    ...
    >
      {variant === 'primary' && (
        <Grid
          ...
          style={{
            paddingRight:
              imageSize === 12 || (theme && theme === 'dark') ? 'auto' : 10
          }}
        >
          ...
          <input
            className={
              theme === 'dark'
                ? classes.textFieldImgTitleDescDark
                : classes.textFieldImgTitleDesc
            }
            name={title}
            type="text"
            value={title}
          ...
          <textarea
            className={
              theme === 'dark'
                ? classes.textAreaImgTitleDescDark
                : classes.textAreaImgTitleDesc
            }
            value={desc}
            onChange={(elem) => {
            ...
            >
              ...
              {imageSize === 12 ? (
                <Box>
                  ...
                  <Box
                    component="span"
                    color={theme === 'dark' ? '#00BFFF' : '#29e8dc'}
                  >
      ...
      {variant === 'secondary' && (
        <Grid
          ...
          style={{
            paddingRight:
              imageSize === 12 || (theme && theme === 'dark') ? 'auto' : 0
          }}
        >
          <Box display="flex" alignItems="center">
            <Box
