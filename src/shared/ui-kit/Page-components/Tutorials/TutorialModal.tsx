...
export default function TutorialModal(props) {
  ...
  const handleFinishTutorial = () => {
    const body = {
      ...
      tutorialsSeen: {
        communities:
          props.tutorial === 'communities'
            ? true
            : user.tutorialsSeen.communities,
        pods: props.tutorial === 'pods' ? true : user.tutorialsSeen.pods,
        creditPools:
          props.tutorial === 'creditPools'
            ? true
    ...
    if (
      ...
      updateTask(
        user.id,
        'Read at least 3 pop-up sections (1st screen and 2nd screen)'
      );
    }
      ...
      >
        <div className="modal-content tutorials-modal">
          ...
          <div
            ...
            style={{
              backgroundImage: `url(${require(`assets/tutorialImages/${tutorials[index].Image}.webp`)})`,
          ...
          <div className="bottom">
            <span>
              {index === 0
                ? 'Introduction'
                : `${index} of ${tutorials.length - 1}`}
            </span>
            <button
              onClick={
                index < tutorials.length - 1 ? handleNext : handleFinishTutorial
              }
            >
