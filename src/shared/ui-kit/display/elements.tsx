  ...
  return (
    ...
    >
      <div className={styles.finalStepContent}>
        <img
          src={require('assets/mediaIcons/pencil.svg')}
          alt="final step pencil"
        />
        <div className={styles.title}>Final Step!</div>
        <p>
          Your wallet will request you you to sign to authenticate the process
        </p>
        <CircularProgress
          style={{ color: theme === 'dark' ? '#A306BA' : '#23D0C6' }}
        />
      </div>
    </Modal>
  );
...
export const WalletSignatureRequestModal = ({
  isOpen,
  onClose,
  onPostProcess = () => {}
}) => {
      ...
      <div className={styles.body}>
        <div className={styles.logo}>
          ...
          <img
            ...
            src={require(`assets/tokenImages/ETH.webp`)}
            alt="Etherum"
          />
          <div className={styles.container}>
            ...
            >{`${balance[0].amount} ${balance[0].symbol}`}</div>
          </div>
        </div>
        ...
        <div className={styles.longDesc}>
          ...
          <p className={styles.messageContent}>
            To avoid digital cat burglars, sign below to authenticate with
            CrypoKitties.
          </p>
        </div>
        <Divider />
