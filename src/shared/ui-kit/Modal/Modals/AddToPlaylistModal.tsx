    ...
    >
      <div className={styles.modalContent}>
        <div className={styles.exit} onClick={props.handleClose}>
          <img src={require('assets/icons/cross_gray.webp')} alt={'x'} />
        </div>
        <div className={styles.content}>
              ...
              <div
                ...
                onClick={() => {
                  ...
                  if (selectedPlaylistsCopy.includes(playlist)) {
                    selectedPlaylistsCopy.splice(
                      selectedPlaylistsCopy.indexOf(playlist),
                      1
                    );
                  } else {
                ...
                <div className={styles.left}>
                  ...
                  <div className={styles.column}>
                    ...
                    <div className={styles.length}>
                      {`${
                        playlist.EthMedias && playlist.MusicMedias
                          ? playlist.EthMedias.length +
                            playlist.MusicMedias.length
                          : 0
                      } Videos`}
                    </div>
                  </div>
          ...
          <div className={styles.buttons}>
            <PrimaryButton size="medium" onClick={handleOpenPlaylistModal}>
              + Create
            </PrimaryButton>
            <PrimaryButton size="medium" onClick={handleAddToPlaylists}>
              Done
            </PrimaryButton>
          </div>
        </div>
