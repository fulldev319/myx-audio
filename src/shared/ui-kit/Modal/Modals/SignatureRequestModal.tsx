...
import MusicLogo from 'assets/logos/MusicLogo2.svg';
import MusicLogoWhite from 'assets/logos/music_white.webp';
import MusicTokenImage from 'assets/icons/audio_token.svg';
  ...
  return (
    <>
      ...
      >
        <div
          className={
            theme === 'dark' ? classes.modalContentDark : classes.modalContent
          }
        >
          {/* <div className={classes.root}> */}
          <div className="image">
            <img
              src={theme === 'dark' ? MusicLogoWhite : MusicLogo}
              alt="Music Wallet Image"
            />
          </div>
          {theme === 'dark' && (
            <Box width="100%">
          ...
          {title || (
            <h3 className="title">
              Your signature is being {!theme && <br />} requested
            </h3>
          )}
          {theme === 'dark' && (
            <Box width="100%">
          ...
          {transactionFee && (
            <div className="transaction-info">
              ...
              <span className="info">
                <img src={MusicTokenImage} alt="Music Token Image"></img>
