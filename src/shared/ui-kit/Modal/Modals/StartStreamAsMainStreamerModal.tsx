...
export const StartStreamAsMainStreamerModal: React.FunctionComponent<
  StartStreamAsMainStreamerModalProps
> = ({ isOpen, onClose, onStart }) => (
  <Modal size="small" isOpen={isOpen} onClose={onClose} showCloseIcon>
    ...
    <Divider />
    <Paragraph>
      You are going to start live streaming. This action will allow other
      streamers, moderators and audience to join.
    </Paragraph>
    <Divider />
