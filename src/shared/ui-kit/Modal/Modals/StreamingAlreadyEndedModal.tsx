...
export const StreamingAlreadyEndedModal: React.FunctionComponent<
  StreamingAlreadyEndedProps
> = ({ isOpen, onClose, streaming }) => (
  <Modal size="small" isOpen={isOpen} onClose={onClose} showCloseIcon>
    ...
    <Divider />
    <Paragraph>
      This streaming was ended at {formatDateTimeWithNA(streaming.endedTime)}.
    </Paragraph>
    <Divider />
