...
const AppBar = styled(MuiAppBar)<AppBarProps>`
  && {
    ...
    background-color: ${(props) =>
      props.type === 'primary' ? 'white' : 'transparent'};
    box-shadow: none;
    overflow-x: auto;
    border-radius: 0;
    ...
    .MuiTab-root {
      ...
      text-transform: ${(props) =>
        props.theme === 'green' ? 'uppercase' : 'none'};
      white-space: nowrap;
      padding: ${(props) =>
        props.padding !== undefined ? `${props.padding}px` : '6px 12px'};
      margin-right: ${(props) => (props.$ismobile ? '4px' : '10px')};
      margin-left: ${(props) => (props.$ismobile ? '4px' : '10px')};
      font-size: ${(props) =>
        props.size === 'large'
          ? FontSize.L
